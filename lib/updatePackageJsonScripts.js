...
module.exports = function updateScripts(framework) {
  ...
  dhLintScripts['lint:vue'] = dhLintScripts['lint:vue'].replace('%PATH%', frameworkLintPaths[framework])
  dhLintScripts['lint:vue-fix'] = dhLintScripts['lint:vue-fix'].replace('%PATH%', frameworkLintPaths[framework])
